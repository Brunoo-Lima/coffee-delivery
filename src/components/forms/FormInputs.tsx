...
type FormInputsProps = {
  handleOrderFinished: () => void;
};

const FormInputs = forwardRef<HTMLFormElement, FormInputsProps>(
  ({ handleOrderFinished }, ref) => {
    const {
      register,
      handleSubmit,
      formState: { errors },
    ...
    return (
      <form onSubmit={handleSubmit(createAddress)} ref={ref}>
        ...
        <button
          className="bg-yellow p-3 ml-2 mt-4 w-48 rounded-md hover:bg-yellow_dark transition duration-300 "
          type="submit"
        >
